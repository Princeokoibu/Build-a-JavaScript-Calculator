...
const Display = ({ input, output }) => {
  return /*#__PURE__*/(
    React.createElement("div", {
      ...
      style: { height: "80px" } }, /*#__PURE__*/

    React.createElement("span", { className: "text-secondary h3 p-0 m-0" }, output), /*#__PURE__*/
    React.createElement("span", { id: "display", className: "text-dark h2 p-0 m-0" },
    input)));
...
const Keyboard = ({ handleInput }) => {
  return /*#__PURE__*/(
    ...
    calcData.map((data, index) => /*#__PURE__*/
    React.createElement(Key, { data: data, handleInput: handleInput }))));
...
const App = () => {
  return /*#__PURE__*/(
    React.createElement("div", { className: "min-vh-100 d-flex justify-content-center align-items-center" }, /*#__PURE__*/
